...
import 'package:lexa/presentation/features/topic/pages/create_vocabulary_page.dart';
import 'package:lexa/presentation/features/topic/widgets/form_drop_down.dart';
import 'package:lexa/presentation/features/topic/widgets/form_text_field.dart';
import 'package:lexa/presentation/features/topic/widgets/taggable_form_text_field.dart';
                            ...
                            child: Column(
                              children: [
                                ...
                                FormTextField(
                                  ...
                                  onChanged: (name) {
                                    _createTopicBloc.add(
                                      UpdateNewTopic(
                                        topic: state.topic.copyWith(
                                          data: state.topic.data.copyWith(name: name),
                                        ),
                                      ),
                                    );
                                  },
                                ...
                                FormTextField(
                                  ...
                                  onChanged: (description) {
                                    _createTopicBloc.add(
                                      UpdateNewTopic(
                                        topic: state.topic.copyWith(
                                          data: state.topic.data.copyWith(description: description),
                                        ),
                                      ),
                                    );
                                  },
                                ...
                                TaggableFormTextField(
                                  ...
                                  onChanged: (tags) {
                                    _createTopicBloc.add(
                                      UpdateNewTopic(
                                        topic: state.topic.copyWith(
                                          data: state.topic.data.copyWith(tags: tags),
                                        ),
                                      ),
                                    );
                                  },
                                ...
                                FormDropdown<Group>(
                                  ...
                                  onChanged: (group) {
                                    _createTopicBloc.add(
                                      UpdateNewTopic(
                                        topic: state.topic.copyWith(
                                          data: state.topic.data.copyWith(group: group?.id),
                                        ),
                                      ),
                                    );
                                  },
                                    ...
                                    Radio(
                                      ...
                                      onChanged: (visibility) {
                                        _createTopicBloc.add(
                                          UpdateNewTopic(
                                            topic: state.topic
                                                .copyWith(data: state.topic.data.copyWith(visibility: visibility)),
                                          ),
                                        );
                                      },
                                    ),
                                ...
                                ListView.builder(
                                  ...
                                  itemCount: state.topic.data.vocabularies.length,
                                  itemBuilder: (context, index) {
                                    CreateVocabularyDto vocabulary = state.topic.data.vocabularies[index];
                                    return ListTile(
                                      ...
                                      subtitle: Text(vocabulary.meaning.toString()),
                                    );
                                  },
                                ),
                              ],
