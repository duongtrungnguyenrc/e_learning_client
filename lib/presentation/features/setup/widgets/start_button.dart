  ...
  Widget build(BuildContext context) {
    return ElevatedButton(
        ...
        style: ButtonStyle(
          ...
          padding: MaterialStateProperty.all<EdgeInsetsGeometry>(const EdgeInsets.all(6)),
        ),
        child: Padding(
          ...
          child: AnimatedContainer(
            ...
            child: Row(
              mainAxisAlignment: widget.isActive ? MainAxisAlignment.spaceBetween : MainAxisAlignment.center,
              children: [
                Visibility(
                ...
                Image.asset(
                  widget.isActive ? "assets/icons/contained_right_arrow.png" : "assets/icons/right_arrow_white.png",
                  width: 52,
                  height: 52,
                )
              ],
