...
import 'package:lexa/utils/date.utils.dart';
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    ListView.builder(
                      shrinkWrap: true,
                      itemCount: learningSessions[_tabController.index].length,
                      itemBuilder: (context, index) {
                        var learningSession =
                            learningSessions[_tabController.index][index];

                        return ListTile(
                          title: Text(learningSession.id),
                          subtitle: Text(learningSession.time),
                        );
                      },
                    ),
                  ],
