...
import 'package:lexa/presentation/features/learning/widgets/author_segment.dart';
import 'package:lexa/presentation/features/learning/widgets/learning_history_segment.dart';
import 'package:lexa/presentation/features/learning/widgets/learning_option_picker_segment.dart';
import 'package:lexa/presentation/features/learning/widgets/vocabulary_list_segment.dart';
...
class _TopicDetailPageState extends State<TopicDetailPage> {
            ...
            children: [
              AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  color: _scrollPosition >=
                          mediaQueryData.size.height / 4 -
                              mediaQueryData.padding.top
                      ? ColorConstants.white
                      : Colors.transparent,
                ),
                child: _buildBackgroundImage(mediaQueryData, topic),
              ),
              SafeArea(
                child: Column(
                  children: [
  ...
  Widget _buildBackgroundImage(MediaQueryData mediaQueryData, Topic? topic) {
    if (_scrollPosition >=
        mediaQueryData.size.height / 4 - mediaQueryData.padding.top) {
      ...
      return CachedNetworkImage(
        ...
        placeholder: (_, __) => _buildSkeleton(
            mediaQueryData.size.width, mediaQueryData.size.height / 2),
